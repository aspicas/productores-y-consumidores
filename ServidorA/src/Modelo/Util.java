 ...
 */
public class Util {
    public static final String SERVER_TAG = "Servidor";
    ...
    public static final String PRIMITIVA_TAG ="Protocolo";
   ...
   public static final String ERROR_SERVER_TAG = "Error loading User from XML - Error in the attribute " + SERVER_TAG + " of the XML tag"; 
    ...
    public static final String USERS_XML_PATH = "src/modelo/servidor.xml";
}
